...
# Description:    This Ruby script is used to batch download Fullmetal Alchemis comic books which are hosted on http://www.jumpcn.com.
#                 Make ensure wget program can be found via PATH environment variable. The Windows version of wget program can be found at http://users.ugent.be/~bpuype/wget/.
#
#                 Usage:
#                 ruby fullmetal_alchemist_comic_book_download_script.rb chapter
#
#                 Note: 
#                 the chapter argument must be an Integer. Up to now, the valid chapter should be in eval((1..18).to_a + (74..100).to_a)
#
...
def download_chapter_pics(chapter)
  ...
  command_template = 'wget --directory-prefix="Fullmetal Alchemist/%03d" http://gc.jumpcn.com/1/g/gang-zhi-lian-jin-shu-shi/%d/%03d.jpg'
  i = 0
  loop do
    i += 1
